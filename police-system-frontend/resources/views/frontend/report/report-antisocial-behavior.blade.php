...
@section('content')
<h1>Report: Antisocial Behavior</h1>
<p class="text" style="text-align: center;">If you have witnessed or experienced any form of antisocial behavior in
...
<form action="#" method="post" onsubmit="submitForm(); return false;" class="form-container">
    ...
    <label for="behavior-location">Behavior Location:</label>
    <input type="text" id="behavior-location" name="behavior-location" required><br><br>

    <label for="behavior-description">Behavior Description:</label><br>
    <textarea id="behavior-description" name="behavior-description" rows="4" cols="50" required></textarea><br><br>
    ...
    <label for="photo">Upload a Photo or Video of the Behavior:</label>
